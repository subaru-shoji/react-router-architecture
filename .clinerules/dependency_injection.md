# Dependency Injection Rules (DI Rules)

## Client-side Dependency Injection Rules


`app/di/client_di.ts`で以下のように実装する
...
## Server-side Dependency Injection Rules

`app/di/server_di.ts`で以下のように実装する
